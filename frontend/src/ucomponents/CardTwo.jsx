...
const CardTwo = () => {
  return (
    <>
        <div href='#' className='border-[1.5px] flex flex-col gap-2 hover:bg-gray-200/50 hover:cursor-pointer w-[360px] m-2 p-4 rounded-xl border-gray-300'>
            ...
            <h2 className='font-bold'>₹399 <span className='text-gray-500 font-normal line-through'>₹3109</span></h2>
        </div>
    </>
  )
}
